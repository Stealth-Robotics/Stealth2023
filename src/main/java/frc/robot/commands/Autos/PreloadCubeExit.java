...
public class PreloadCubeExit extends SequentialCommandGroup {
  // creates variables for the drivebase and defaultconfig.
  private final TrajectoryConfig defaultConfig;

  public PreloadCubeExit(DrivebaseSubsystem driveBase, CrocodileSubsystem croc, RotatorSubsystem rotator,
