...
public class BluePreloadPlusOneRight extends SequentialCommandGroup {
  ...
  public BluePreloadPlusOneRight(Swerve driveBase) {
    ...
    addCommands(
      ...
      new SwerveControllerFollower(driveBase,  "preloadPlusOneRight1", defaultConfig, false, true),
      new SwerveControllerFollower(driveBase,  "preloadPlusOneRight2", defaultConfig, false, false)
    );
