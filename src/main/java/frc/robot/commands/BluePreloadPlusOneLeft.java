...
public class BluePreloadPlusOneLeft extends SequentialCommandGroup {
  ...
  public BluePreloadPlusOneLeft(Swerve driveBase) {
    ...
    addCommands(
      ...
      new SwerveControllerFollower(driveBase,  "preloadPlusOneLeft1", defaultConfig, false, true),
      new SwerveControllerFollower(driveBase,  "preloadPlusOneLeft2", defaultConfig, false, false)
    );
