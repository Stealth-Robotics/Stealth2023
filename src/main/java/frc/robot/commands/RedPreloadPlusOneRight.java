...
public class RedPreloadPlusOneRight extends SequentialCommandGroup {
  ...
  public RedPreloadPlusOneRight(Swerve driveBase) {
    ...
    addCommands(
      ...
      new SwerveControllerFollower(driveBase,  "preloadPlusOneRight1", defaultConfig, true, true),
      new SwerveControllerFollower(driveBase,  "preloadPlusOneRight2", defaultConfig, true, false)
    );
