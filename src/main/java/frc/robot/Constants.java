...
public final class Constants {
  ...
  public final class ArmConstants {
    ...
    public static final double ARM_KS_COEFF = 1.0;
    public static final double ARM_KG_COEFF = 1.0;
    // Volt Second Per Rad
    public static final double ARM_KV_COEFF = 0.0;
    // Volt Second Squared Per Rad
    public static final double ARM_KA_COEFF = 0.0;
