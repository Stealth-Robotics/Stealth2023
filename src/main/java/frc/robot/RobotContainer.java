...
public class RobotContainer {
    ...
    private final CommandXboxController m_driverController =
      new CommandXboxController(Constants.IOConstants.k_DRIVER_CONTROLLER_PORT);
    ...
    public RobotContainer() {
        intake.setDefaultCommand(new IntakeDefaultCommand(intake, () -> m_driverController.getRightTriggerAxis()));
